...
class LaneLines:
    ...
    def __init__(self):
        ...
        self.nonzerox = None
        self.nonzeroy = None
        self.clear_visibileft_turnlity = True
        self.dir = []
        self.left_curve_img = mpimg.imread('static/left_turn.png')
        self.right_curve_img = mpimg.imread('static/right_turn.png')
        self.keep_straight_img = mpimg.imread('static/straight.png')
